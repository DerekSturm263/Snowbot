...
export function build_new_help() {
	return new EmbedBuilder()
        ...
        .setDescription(
            ...
            '- `/setup` (admins only): Lets you set up custom objects, buildings, pets, and events for this server.\n\n' +

            '- `/reset`: Resets all of your stats and achievements to their defaults.\n\n' +

            `If you experience any issues, want to give feature requests, or want to test our new features, join the official development server [here](https://discord.gg/tpfVdFsYKg).`
        );
};
